...
public class ClickActivityTest2 {
    ...
    public void clickActivityTest3() {
        ViewInteraction activityLabel = onView(
                allOf(childAtPosition(
                        childAtPosition(
                                withClassName(is("ch.bailu.aat.views.preferences.VerticalScrollView")),
                                0),
                        1),
                        isDisplayed()));
        activityLabel.perform(click());
        ...
        ViewInteraction solidIndexListView = onView(
                allOf(childAtPosition(
                        ...
                        0),
                        isDisplayed()));
        solidIndexListView.perform(click());
